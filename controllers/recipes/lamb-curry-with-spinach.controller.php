...
$pageTitle = 'Lamb Curry with Spinach | Nutty\'s Kitchen';
...
TEXT;
$ogDescription = <<<'TEXT'
Lamb curry with spinach, or Saag Gosht as it is known is from the Punjab
TEXT;
...
require __DIR__ . '/../../views/recipes/lamb-curry-with-spinach.view.php';

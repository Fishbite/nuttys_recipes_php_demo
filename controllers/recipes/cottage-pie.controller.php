...
$pageTitle = 'Cottage Pie | Nutty\'s Kitchen';
...
TEXT;
$ogDescription = <<<'TEXT'
Cottage Pie! Who can resist rich beefy ragu style minced beef topped off with hot creamy mash
TEXT;
...
require __DIR__ . '/../../views/recipes/cottage-pie.view.php';

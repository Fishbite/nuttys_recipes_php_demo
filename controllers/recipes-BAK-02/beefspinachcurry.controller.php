...
TEXT;
$ogDescription = <<<'TEXT'
a delicate curry not overly complicated or heavily spiced
TEXT;
...
require __DIR__ . '/../../views/recipes/beefspinachcurry.view.php';

...
$pageTitle = 'Chocolate Cake | Nutty\'s Kitchen';
...
TEXT;
$ogDescription = <<<'TEXT'
Chocolate Cake with butter cream and fruit & nut topping is a real treat
TEXT;
...
require __DIR__ . '/../../views/recipes/chocolate-cake.view.php';

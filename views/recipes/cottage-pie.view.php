  ...
  <section>
    <header class="title">
      ...
      <p>
        ...
        &mdash; so it has to feature in Nutty's Kitchen dishes, it's a true
        ...
        from<em> Thomson House Cottage Pie: A History</em> &mdash; fascinating
    ...
    <div class="about-center section-center">
      <article class="about-img">
        <img src="/images/cottage-pie/650x366/cottage-pie-cooked-1.webp" alt="cottage pie cooked 1"
          title="cottage pie in square serving dish" />
      </article>
        ...
        <article class="about-content">
          ...
          <div class="content active" id="ingredients">
            ...
            <ul>
              ...
              <li>2 tsp Bovril&trade; beef paste</li>
          ...
          <div class="content" id="method">
            ...
            <p>
              ...
              going to work, there's <em>No Beef in Marmite&trade;</em> - save
              that for ya toast! If you do not have Bovril add another beef
              stock cube & or, if your wallet allows, red wine &mdash; No
            ...
            <ol>
              <li>Dissolve your OXO&trade; cubes in hot water</li>
            ...
            <div class="card_image">
              ...
              <img src="/images/cottage-pie/650x366/carrots-celery-onion-mince.webp" alt="carrots celery onion mince"
            ...
            <ol start="8">
              ...
              <li>Season with your OXO&trade; liquid, salt & pepper</li>
              <li>Add Worcestershire sauce & Bovril&trade;</li>
            ...
            <div class="card_image">
              ...
              <img src="/images/cottage-pie/650x366/cottage-pie-filling-cooking.webp" alt="cottage pie filling cooking"
            ...
            <div class="card_image">
              ...
              <img src="/images/cottage-pie/650x366/mash-in-pan.webp" alt="mash in pan"
            ...
            <p>
              ...
              crispy topping &mdash; use a large dish to maximize the amount
            ...
            <div class="card_image">
              ...
              <img src="/images/cottage-pie/650x366/cottage-pie-filling-in-dish.webp" alt="cottage pie filling in dish"
            ...
            <div class="card_image">
              ...
              <img src="/images/cottage-pie/650x366/cottage-pie-mash-around-edges.webp"
                alt="cottage pie mash around edges" title="cottage pie with some mash around the edges" />
            </div>
            <div class="spacer"></div>
            ...
            <div class="card_image">
              ...
              <img src="/images/cottage-pie/650x366/cottage-pie-ready-for-oven.webp" alt="cottage pie ready for oven"
            ...
            <div class="card_image">
              ...
              <img src="/images/cottage-pie/650x366/cottage-pie-cooked-2.webp" alt="cottage pie cooked 2"
            ...
            <div class="card_image_round">
              ...
              <img src="/images/cottage-pie/650x366/cottage-pie-serving-1.webp" alt="cottage pie serving 1"
          ...
          <section class="related">
            ...
            <ul>
              <li>
                <a class="underline" href="https://www.nuttyskitchen.co.uk/cornedbeefmashpie.html">corned beef mash pie
                </a>
              </li>
              <li>
                <a href="https://www.nuttyskitchen.co.uk/lambmashpie.html" class="underline">sheperds pie
                </a>
              </li>
            </ul>
          </section>

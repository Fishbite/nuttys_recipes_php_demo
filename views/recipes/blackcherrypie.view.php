  ...
  <section>
    ...
    <div class="about-center section-center">
      <article class="about-img">
        <img src="/images/blackcherrypie/650x366/cherry-pie-cooked.jpg" alt="cherry pie cooked" />
      </article>
      ...
      <article class="about">
        ...
        <article class="about-content">
          ...
          <div class="content" id="method">
            ...
            <div class="card_image">
              <figcaption>black cherry pie</figcaption>
              <img src="/images/blackcherrypie/650x366/cherry-pie-cream-served.jpg" alt="cherry pie cream served" />
            </div>
            <div class="spacer"></div>
          ...
          <section class="related">
            ...
            <ul>
              <li>
                <a class="underline" href="https://www.nuttyskitchen.co.uk/damson-and-soured-cream-tart.html">damson &
                  soured cream tart
                </a>
              </li>
              <li>
                <a href="https://www.nuttyskitchen.co.uk/blackberry-and-soured-cream-flan.html"
                  class="underline">blackberry & soured cream flan
                </a>
              </li>
            </ul>
          </section>

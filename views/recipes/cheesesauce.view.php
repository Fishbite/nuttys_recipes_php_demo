  ...
  <section>
    ...
    <div class="about-center section-center">
      <article class="about-img">
        <img src="/images/cheesesauce/650x366/cheese-sauce-in-pan.jpg" alt="cheese sauce in a pan" />
      </article>
      ...
      <article class="about">
        ...
        <article class="about-content">
          ...
          <section class="related">
            ...
            <ul>
              <li>
                <a class="underline" href="https://www.nuttyskitchen.co.uk/whitesauce.html">white sauce
                </a>
              </li>
              <li>
                <a href="https://www.nuttyskitchen.co.uk/onionsauce.html" class="underline">onion sauce
                </a>
              </li>
            </ul>
          </section>

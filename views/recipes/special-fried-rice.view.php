    ...
    <section class="fg">
      <header class="title">
        ...
        <p>
          ...
          away before you start to cook. If you love that take-away but feel "I
          want more taste!" well this is it - without an additive in sight -
          Nutty style!
        </p>
        ...
        <article class="about">
          ...
          <article class="about-content">
            ...
            <div class="content" id="method">
              ...
              <ol start="14">
                <li>
                  Set aside in a heated serving dish as you cook your
                  beansprouts side dish
                </li>
              </ol>
